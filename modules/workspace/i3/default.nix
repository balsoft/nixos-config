    ...
    config = rec {
      ...
      startup = map (a: { notification = false; } // a) [
        ...
        }
        {
          ...
          }/lib/libexec/polkit-kde-authentication-agent-1";
        }
        {
          command = "${
            pkgs.keepassxc
          }/bin/keepassxc /home/balsoft/projects/nixos-config/misc/Passwords.kdbx";
        }
        {
      ...
      in ({
        ...
        "${modifier}+i" = "sh -c 'xclip -out | curl -F \"f:1=<-\" ix.io'";
